...
@section('about-me-content')
	...
	<div class='title-box'>
		 <div class="page-title"><span class="bar-line">|</span> Hello World! <span class="bar-line">|</span></div>
	</div>
			...
			<div class="span8 offset2">
				<div class="content"> 
					<div class="content-title-container">
						<p class="content-title">My name is Benjamin Bhamdeo. My friends call me Ben.</p>
					</div>
					<p>I am a proud graduate of 
						<a class="rutgers-link" href="http://www.rutgers.edu/">Rutgers University</a> 
						and an even prouder pupil of the 
						<a href="http://en.wikipedia.org/wiki/Classics">Classics.</a></p>
					...
					<p>I like fantasy/sci fi, a well-written script, World Culture, J.R.R. Tolkien, Starcraft II 
						& E-Sports, 
						<a href="http://en.wikipedia.org/wiki/Video_games_as_an_art_form">Quality Video Games</a>, 
						Team Fortress 2, Exercise & Meditation, Coffee & Tea, 
					...
					<p>Take a look around! If you like what you see and want to get in touch, good news: 
